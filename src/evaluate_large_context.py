...
# A 3000x3000 reference becomes roughly 300x300 in the search image.
BASE_TEMPLATE_SIZE = 300

# Small, realistic uncertainty range.
SCALES_TO_TRY = [0.98, 1.00, 1.02]
ANGLES_TO_TRY = [-1.0, -0.5, 0.0, 0.5, 1.0]

# The center tie-break applies only to almost identical scores.
...
print()
print("========== LARGE-CONTEXT EVALUATION ==========")
print("Reference template size:", BASE_TEMPLATE_SIZE, "x", BASE_TEMPLATE_SIZE)
